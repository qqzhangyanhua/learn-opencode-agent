...
<ChapterLearningGuide :audience="['已经跑通过最小 Agent，准备进入多步推理与调试链路的人']" />
...
<ChapterActionPanel
  :actionItems="[
    { title: '故意让 Thought 偏一次', description: '修改提示词或工具描述，让模型选错工具，再观察 ReAct 输出如何帮助你定位问题。' },
    { title: '进入中级篇 Planning 机制', description: '把 ReAct 的局部推理提升到计划、执行和重规划层面。', href: '/intermediate/27-planning-mechanism/' },
    { title: '回看会话管理', description: '把显式推理链和消息结构、循环控制重新对应起来，理解它如何落在 Session 主链路上。', href: '/04-session-management/' }
  ]"
/>
