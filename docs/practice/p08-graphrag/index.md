...
<ProjectCard
  title="你将构建：一个基于知识图谱的 RAG 系统，能回答「张三的同事负责什么项目？」"
  difficulty="advanced"
  duration="60 min"
  :prerequisites="['P7']"
...
- 建议先完成前置章节：`P7`
- 本章建议入口命令：`bun run p08-graphrag.ts`
- 示例文件位置：`practice/p08-graphrag.ts`
...
<RunCommand command="bun run p08-graphrag.ts" :verified="true" />
