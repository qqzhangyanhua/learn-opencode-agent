...
<GraphRagDemo
  :nodes="[
    ...
    { id: 'projecta', label: '项目A', type: 'project', x: 400, y: 150 },
    { id: 'tech', label: '技术部', type: 'department', x: 250, y: 250 },
    { id: 'wangwu', label: '王五', type: 'person', x: 400, y: 250 },
    { id: 'typescript', label: 'TypeScript', type: 'tech', x: 550, y: 150 }
  ]"
  :edges="[
    { from: 'zhangsan', to: 'lisi', relation: '同事' },
    { from: 'zhangsan', to: 'tech', relation: '属于' },
    { from: 'lisi', to: 'projecta', relation: '负责' },
    { from: 'tech', to: 'wangwu', relation: '包含' },
    { from: 'projecta', to: 'typescript', relation: '使用' }
  ]"
