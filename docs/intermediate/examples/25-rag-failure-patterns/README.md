...
- `SILICONFLOW_API_KEY`：仅在涉及 Embedding/向量请求的脚本中校验，包括 `v1_chunk_problem.py`、`v2_embedding_problem.py`、`v3_hybrid_search.py`、`v4_prompt_control.py` 和 `production_rag.py`；`v5_metadata_conflict.py` 等仅需 `DEEPSEEK_API_KEY`。
