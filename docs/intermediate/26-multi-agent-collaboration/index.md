...
shortTitle: 让多个 AI 协作起来
summary: 从主从、辩论、流水线三种模式切入，理解多智能体协作为什么能提升复杂任务的可控性，以及它的真实成本与边界。
difficulty: advanced
estimatedTime: 30 分钟
learningGoals:
  - 从主从
...
先切换三种模式，再点击底部阶段，对照右侧说明面板，看它们在结构、风险和结果回流方式上的差异。
