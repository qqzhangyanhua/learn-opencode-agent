---
title: "附录 Q｜Tool Call 持久化专章：Hermes 为什么不只存最终回答，而要存消息、工具调用、工具结果、推理痕迹"
description: "Hermes 为什么不只存最终回答，而要存消息、工具调用、工具结果、推理痕迹。基于 Hermes Agent 拆解专栏，源码拆解「Tool Call 持久化专章」。"
---
